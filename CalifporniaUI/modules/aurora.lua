...
local classcolors = Califpornia.colors.class_colors
...
Aurora = {
	...
	["checked"] = "Interface\\AddOns\\CalifporniaUI\\media\\textures\\CheckButtonHilight",
	["glow"] = "Interface\\AddOns\\CalifporniaUI\\media\\textures\\glow",
}
...
Aurora.ReskinScroll = function(f)
	...
	tex:SetGradient("VERTICAL", .25, .25, .25, .30, .30, .30)
	...
	uptex:SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\arrow-up-active")
	uptex:SetSize(8, 8)
	uptex:SetPoint("CENTER")
	uptex:SetVertexColor(1, 1, 1)

	local downtex = down:CreateTexture(nil, "ARTWORK")
	downtex:SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\arrow-down-active")
	downtex:SetSize(8, 8)
...
Aurora.ReskinArrow = function(f, direction)
	...
	if direction == 1 then
		tex:SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\arrow-left-active")
	elseif direction == 2 then
		tex:SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\arrow-right-active")
	end
end
...
Skin:SetScript("OnEvent", function(self, event, addon)
	if addon == "CalifporniaUI" then
		...
		hooksecurefunc("CharacterFrame_Expand", function()
			select(14, CharacterFrameExpandButton:GetRegions()):SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\arrow-left-active")
		end)

		hooksecurefunc("CharacterFrame_Collapse", function()
			select(14, CharacterFrameExpandButton:GetRegions()):SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\arrow-right-active")
		end)
		...
		Aurora.CreateBD(MerchantGuildBankRepairButton)
		...
		Aurora.CreateBD(MerchantRepairAllButton)
		...
		Aurora.CreateBD(MerchantRepairItemButton)
		local ic = MerchantRepairItemButton:GetRegions()
		ic:SetPoint("TOPLEFT", 1, -1)
		ic:SetPoint("BOTTOMRIGHT", -1, 1)
		ic:SetTexCoord(0.04, 0.24, 0.06, 0.5)
		...
		for i = 1, #PAPERDOLL_SIDEBARS do
			...
			tab.Highlight:SetTexture(c.r, c.g, c.b, .2)
		...
		for i = 1, 2 do
			...
			local ic = _G["StaticPopup"..i.."ItemFrameIconTexture"]
		...
		if not IsAddOnLoaded("Butsu") and not IsAddOnLoaded("XLoot") then
			...
			LootFrame:HookScript("OnShow", function()
				for i = reskinned, GetNumLootItems() do
					...
					ic:SetPoint("BOTTOMRIGHT", -1, 1)
					bg:Hide()
					qu:SetTexture("Interface\\AddOns\\CalifporniaUI\\media\\textures\\quest")
		...
		if not IsAddOnLoaded("CalifporniaUI") and not IsAddOnLoaded("CowTip") and not IsAddOnLoaded("TipTac") and not IsAddOnLoaded("FreebTip") and not IsAddOnLoaded("lolTip") and not IsAddOnLoaded("StarTip") then
			do
				local tooltips = {
					"GameTooltip",
					"ItemRefTooltip",
	...
	elseif addon == "Blizzard_GlyphUI" then
		...
		for i = 1, 12 do
			...
			check:SetVertexColor(c.r, c.g, c.b, .2)

--[[
        An edited lightweight OmniCC taken from Tukui
...
if IsAddOnLoaded("OmniCC") or IsAddOnLoaded("ncCooldown") or CalifporniaCFG.omnicc.enable ~= true then return end

OmniCC = true --hack to work around detection from other addons for OmniCC
local ICON_SIZE = 36 --the normal size for an icon (don't change this)
local FONT_FACE = CalifporniaCFG.media.font --what font to use
...
local function getTimeText(s)
	...
	if s < CalifporniaCFG.omnicc.treshold + 0.5 then

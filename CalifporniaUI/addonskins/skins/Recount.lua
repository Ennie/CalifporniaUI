if not IsAddOnLoaded("Recount") or not Mod_AddonSkins or not Qulight["addonskins"].Recount == true then return end
...
Mod_AddonSkins:RegisterSkin("Recount",function(Skin, skin, Layout, layout, config)
	...
	Recount.UpdateBarTextures = function(self)
		...
		Recount:SetFont(Qulight["media"].font)
	end

...
local barcfg = CalifporniaCFG['actionbars'].bar4
  

	local bar = CreateFrame("Frame","CalifporniaUI_MultiBarRight",UIParent, "SecureHandlerStateTemplate")
...
--	bar:SetHitRectInsets(-cfg.barinset, -cfg.barinset, -cfg.barinset, -cfg.barinset)
	...
	local Group = CalifporniaCFG.BF:Group('CalifporniaUI', 'MultiBarRight')
	Group:Skin('DsmFade', barcfg.gloss, barcfg.backdrop, {})
	for i=1, 12 do
		local button = _G["MultiBarRightButton"..i]
		button:ClearAllPoints()
		button:SetSize(barcfg.buttonsize, barcfg.buttonsize)
		_G["MultiBarRightButton"..i.."HotKey"]:SetFont(CalifporniaCFG.media.abfont, barcfg.fontsize, "OUTLINE")

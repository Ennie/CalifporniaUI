...
addon:SetScript("OnEvent", function(self, event)
	...
	elseif event == "PLAYER_REGEN_DISABLED" then
		...
		WorldMapQuestShowObjectives.Show = CalifporniaCFG.dummy
		WorldMapTitleButton.Show = CalifporniaCFG.dummy
		WorldMapBlobFrame.Show = CalifporniaCFG.dummy
		WorldMapPOIFrame.Show = CalifporniaCFG.dummy       
